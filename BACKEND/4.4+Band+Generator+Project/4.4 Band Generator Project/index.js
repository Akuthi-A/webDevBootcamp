...
app.post("/submit", (req, res) => {
  ...
  let adj_position = Math.floor(adj.length * Math.random());
  let noun_position = Math.floor(noun.length * Math.random());

  res.render("index.ejs", {adjective: adj[adj_position], noun: noun[noun_position]});
